...
Suppose that we conduct a Bernoulli trial (defined in Section \@ref(bernoulli-trials),
e.g. coin tosses), where we get a success $(S)$ or failure $(F)$ with probabilities $P\{S\}=p$ and $P\{F\}=1-p$ respectively. 
