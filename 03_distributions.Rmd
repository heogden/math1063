...
e.g. coin tosses) such that we get a success $(S)$ or failure $(F)$ with probabilities $P\{S\}=p$ and $P\{F\}=1-p$ respectively. Let $X$ be the number of successes in the $n$ trials. Then $X$ is called a binomial random variable with parameters $n$ and $p$, written as
...
<!-- TODO: check if binomial theorem introduced somewhere? -->
