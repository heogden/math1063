...
morning and afternoon. If we treat time as continuous then the random variable $X =$ "the waiting
-time" could potentially be modelled as a normal random variable. 
...
:::{.example name="Fast food waiting time revisited"}
We would like to find a confidence interval for the true mean waiting time. If $X$ denotes the waiting time in seconds, we have $n=20, \bar{x}=67.85$, $s=18.36$. Hence, recalling that the critical value $h=2.093$, from the command qt $0.975$, df $=19$ ), a $95 \%$ confidence interval for $\mu$ is
\begin{align*}
...
:::{.example name="Weight gain revisited"}
