...
\end{align*}
The MSE of $\hat{\theta}_{2}$ is an order of magnitude (of order $n^{2}$ rather than $n$ ) smaller than the MSE of $\hat{\theta}_{1}$, providing justification for the preference of $\hat{\theta}_{2}=\max \left\{X_{1}, X_{2}, \ldots, X_{n}\right\}$ as an estimator of $\theta$.
